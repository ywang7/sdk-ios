...
#define API_LOGIN_ID @"99S4Y5N32wzh"
#define TRANSACTION_KEY @"6398mh9srYc4LZ8w"

#define USERNAME @"yinghaowang1991"
#define PASSWORD @"Wyh_1991091"
#define MOBILE_DEVICE_ID @"80b9dbc49e4db03b72deb999c7eee7090a44f2405063a6fc11272c60"
...
- (NSString *) doMobileRegistrationAndLoginToGetSessionToken {
	...
	XCTAssertTrue((an.response != nil), @"Response from mobileDeviceRegistrationRequest should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Result Code for mobileDeviceRegistrationResponse was not Ok");
    ...
    XCTAssertTrue([m.code isEqualToString:@"I00006"], @"Response code was NOT I00006.  Device not approved for use!");
...
{
	AuthNet *an = [AuthNet authNetWithEnvironment:ENV_TEST];
	XCTAssertTrue((an.environment != ENV_LIVE), @"Environment should be for LIVE server");	
	XCTAssertTrue((an.environment == ENV_TEST), @"Environment should not be for TEST server");
	an = nil;
    ...
    XCTAssertTrue((an.environment != ENV_TEST), @"Environment should be for TEST server");	
	XCTAssertTrue((an.environment == ENV_LIVE), @"Environment should not be for LIVE server");
...
- (void) testMobileDeviceRegistrationAndLoginRequest
{
    ...
    NSString * sessionToken = [self doMobileRegistrationAndLoginToGetSessionToken];
    XCTAssertNotNil(sessionToken, @"Did not get a session token from registration and login");
...
- (void) testMobileDeviceLoginRequest
{
	...
	XCTAssertTrue((an.response != nil), @"Response from mobileDeviceLoginRequest should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Result Code for mobileDeviceLoginResponse was not Ok");
	...
	XCTAssertTrue((an.response != nil), @"Response from mobileDeviceLoginRequest should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Error"], @"Result Code for mobileDeviceLoginResponse should not be Ok");
...
- (void) testSimpleAuthNetPurchase
{
	...
	XCTAssertTrue((an.response != nil), @"Response from Purchase(AUTH_CAPTURE) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Result Code for Purchase(AUTH_CAPTURE) was not Ok");
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	if (an.response == nil)
		return;
...
-(void) testAuthNetAuthorize
{
	...
	XCTAssertTrue((an.response != nil), @"Response from Authorize transaction should not be nil!");
	
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for Authorization was not APPROVED");
    CreateTransactionResponse *createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	if (an.response == nil)
		return;
	...
	XCTAssertTrue((an.response != nil), @"Response from $0.00 Authorize transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for $0.00 Authorization was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
...
- (void) testAuthNetAuthorizeAndCapture
{
	...
	XCTAssertTrue((an.response != nil), @"Response from Capture transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for Capture was not ERROR");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	...
	XCTAssertTrue((an.response != nil), @"Response from Capture transaction should not be nil!");
	XCTAssertTrue([((CreateTransactionResponse *) an.response).transactionResponse.responseCode isEqualToString:@"3"], @"Response Code for Capture was not ERROR");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertFalse([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"NEGATIVE TESTING: Response Code for Purchase(AUTH_CAPTURE) should not be APPROVED");
	...
	XCTAssertTrue(error, @"Response Code for Capture was not 47");	
	if (an.response == nil)
		return;
	...
	XCTAssertTrue(error, @"Response Code for Capture was not 16");
...
{	
	...
	XCTAssertTrue((an.response != nil), @"Response from Purchase(AUTH_CAPTURE) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
    CreateTransactionResponse *createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	if (an.response == nil)
		return;
	...
	XCTAssertTrue((an.response != nil), @"Response from Purchase(AUTH_CAPTURE) transaction should not be nil!");
	XCTAssertTrue([((CreateTransactionResponse *) an.response).transactionResponse.responseCode isEqualToString:@"3"], @"Response Code for Purchase(AUTH_CAPTURE) with no amount was not ERROR");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertFalse([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"NEGATIVE TESTING: Response Code for Purchase(AUTH_CAPTURE) should not APPROVED");
	...
	XCTAssertTrue(error, @"Response Code for Capture was not 5");
...
- (void) testAuthNetPurchaseAndVoid
{
	...
	XCTAssertTrue((an.response != nil), @"Response from Void transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for Void was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
}
...
- (void) testAuthNetAuthAndCaptureAndVoid
{
	...
	XCTAssertTrue((an.response != nil), @"Response from Capture transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for Capture was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
...
- (void) testECheck {
	...
	XCTAssertTrue((an.response != nil), @"Response from AUTH ECheck transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for Authorization ECheck was not APPROVED");
    CreateTransactionResponse *createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	...
	XCTAssertTrue((an.response != nil), @"Response from PRIOR_AUTH_CAPTURE ECheck transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for PRIOR_AUTH_CAPTURE ECheck was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	...
	XCTAssertTrue((an.response != nil), @"Response from AUTH_CAPTURE ECheck transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for AUTH_CAPTURE ECheck was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
...
//	}
//	XCTAssertTrue((an.response != nil), @"Response from AUTH_CAPTURE ECheck transaction should not be nil!");
//	XCTAssertTrue([((CreateTransactionResponse *)an.response).transactionResponse.responseCode isEqualToString:@"3"], @"Response Code for unknown ECheck was not ERROR");
//
//	a = ((CreateTransactionResponse *)an.response).transactionResponse.errors;
//	error = FALSE;
//	// Potentially multiple errors
...
//			error = TRUE;
//	}
//	XCTAssertTrue(error, @"Response Reason Code for unknown ECheck was not 100");	
...
- (void) testTestRequestFieldWithPurchase {
    ...
    CreateTransactionResponse *createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
    XCTAssertTrue(([[NSString stringWithString:((CreateTransactionResponse *)an.response).transactionResponse.transId] intValue] == 0), @"Transaction ID Purchase(AUTH_CAPTURE) in test mode should be 0");
	if (an.response == nil)
		return;
	...
	XCTAssertTrue((an.response != nil), @"Response from Purchase(AUTH_CAPTURE) transaction should not be nil!");
	XCTAssertTrue([((CreateTransactionResponse *) an.response).transactionResponse.responseCode isEqualToString:@"3"], @"Response Code for Purchase(AUTH_CAPTURE) was not ERROR");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertFalse([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"NEGATIVE TESTING: Response Code for Purchase(AUTH_CAPTURE) should not be APPROVED");
	XCTAssertTrue(([[NSString stringWithString:((CreateTransactionResponse *)an.response).transactionResponse.transId] intValue] == 0), @"Transaction ID Purchase(AUTH_CAPTURE) in test mode should be 0");
	...
	XCTAssertTrue(error, @"Response Reason Code for Purchase(AUTH_CAPTURE) does not match amount (TEST_MODE)");	
}
...
- (void) testLiveAuthNetAuthorize
{
	...
	XCTAssertTrue((an.response != nil), @"Response from Authorize transaction should not be nil!");
	XCTAssertTrue([((AIMCreateTransactionResponse *)an.response).transactionResponse.responseCode isEqualToString:@"3"], @"Response Code for Authorization was not ERROR");
...
{	
	...
	XCTAssertTrue((an.response != nil), @"Response from Purchase(AUTH_CAPTURE) transaction should not be nil!");
	XCTAssertTrue([((AIMCreateTransactionResponse *)an.response).transactionResponse.responseCode isEqualToString:@"3"], @"Response Code for Purchase(AUTH_CAPTURE) was not ERROR");
...
- (void) testAVSWithAuth {
	...
	XCTAssertTrue((an.response != nil), @"Response from AVS (AUTH_ONLY) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for AVS(AUTH_ONLY) was not APPROVED");
    CreateTransactionResponse *createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	XCTAssertTrue([((CreateTransactionResponse *)an.response).transactionResponse.avsResultCode isEqualToString:@"Y"], @"AVS Result was not 'Y' ");	
	if (an.response == nil)
		return;
	...
	XCTAssertTrue((an.response != nil), @"Negative testing: Response from AVS (AUTH_ONLY) transaction should not be nil!");
	XCTAssertTrue([((CreateTransactionResponse *) an.response).transactionResponse.responseCode isEqualToString:@"3"], @"NEGATIVE TESTING: Response Code for AVS(AUTH_ONLY) was not ERROR");
	XCTAssertTrue([((CreateTransactionResponse *)an.response).transactionResponse.avsResultCode isEqualToString:@"P"], @"NEGATIVE TESTING: AVS Result was not 'P' ");	
}
...
- (void) testMerchantFieldsAreEchoed {
	...
	XCTAssertTrue((an.response != nil), @"Response from purchase (AUTH_CAPTURE) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for purcase (AUTH_CAPTURE) was not APPROVED");
    CreateTransactionResponse *createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	...
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value1"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:1]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value2"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:2]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value3"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:3]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value4"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:4]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value5"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:5]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value6"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:6]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value7"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:7]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value8"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:8]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value9"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:9]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value10"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:10]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value11"], @"Merchant field value does not equal what was initially sent");

	value = ((UserField *)[n objectAtIndex:11]).value;
	XCTAssertTrue(value != nil, @"Merchant field value did not get echoed back");
	XCTAssertTrue([value isEqualToString:@"MDF_Value12"], @"Merchant field value does not equal what was initially sent");
}
...
*/	
	...
	XCTAssertTrue((an.response != nil), @"Response from authorize with AmEx (AUTH_ONLY) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for authorize with AmEx (AUTH_ONLY) was not APPROVED");
    CreateTransactionResponse *createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");    
	XCTAssertTrue([((CreateTransactionResponse *)an.response).transactionResponse.accountType isEqualToString:@"AmericanExpress"],
	...
	XCTAssertTrue((an.response != nil), @"Response from authorize with Discover (AUTH_ONLY) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for authorize with Discover (AUTH_ONLY) was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	XCTAssertTrue([((CreateTransactionResponse *)an.response).transactionResponse.accountType isEqualToString:@"Discover"],
	...
	XCTAssertTrue((an.response != nil), @"Response from authorize with MasterCard (AUTH_ONLY) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for authorize with MasterCard (AUTH_ONLY) was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	XCTAssertTrue([((CreateTransactionResponse *)an.response).transactionResponse.accountType isEqualToString:@"MasterCard"],
	...
	XCTAssertTrue((an.response != nil), @"Response from authorize with VISA (AUTH_ONLY) transaction should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code for authorize with VISA (AUTH_ONLY) was not APPROVED");
    createTransactionResponse = (CreateTransactionResponse *)an.response;
	XCTAssertTrue([createTransactionResponse.transactionResponse.responseCode isEqualToString:@"1"], @"Response Code for Purchase(AUTH_CAPTURE) was not APPROVED");
	XCTAssertTrue([((CreateTransactionResponse *)an.response).transactionResponse.accountType isEqualToString:@"Visa"],
...
- (void) testCreditCardCheck {
	...
	XCTAssertTrue (([CreditCardType isValidCreditCardNumber:cc] == YES), @"Luhn Algorithm for credit card should have been valid");
	cc = @"5103312845585953";
	XCTAssertTrue (([CreditCardType isValidCreditCardNumber:cc] == YES), @"Luhn Algorithm for credit card should have been valid");
	cc = @"5310941494599177";
	XCTAssertTrue (([CreditCardType isValidCreditCardNumber:cc] == YES), @"Luhn Algorithm for credit card should have been valid");
	...
	// Negative tests
	cc = @"4916971931396181";
	XCTAssertTrue (([CreditCardType isValidCreditCardNumber:cc] == NO), @"Luhn Algorithm for credit card should have been invalid");
	cc = @"4485099272362583";
	XCTAssertTrue (([CreditCardType isValidCreditCardNumber:cc] == NO), @"Luhn Algorithm for credit card should have been invalid");
...
- (void) testCGIEscape {
	...
	XCTAssertTrue(([[AuthNet cgiEscape:testString1] compare:@"%E2%98%83"] == NSOrderedSame), @"cgiEscape not returning correct hex value.");
}
...
- (void) testPKCS5_PBKDF2 {
	...
	XCTAssertTrue (([secret isEqualToString:str]), @"Decrypted string is not equal to original secret");
...
- (void) testGetSettledBatchListRequest {
    ...
    XCTAssertTrue((an.response != nil), @"Response from Get Settled Batch List should not be nil!");
	XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code Get Settled Batch List was not APPROVED");
...
- (void) testGetTransactionListRequest {
    ...
    for (BatchDetailsType *b in batches) {
        ...
        XCTAssertTrue((an.response != nil), @"Response from Get Transaction List should not be nil!");
        XCTAssertTrue([an.response.anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Result code for Get Transaction List was not APPROVED");
...
- (void) testGetUnsettledTransactionListRequest {
	...
	XCTAssertTrue((an.response != nil), @"Response from Get Settled Batch List should not be nil!");
	XCTAssertTrue([((GetUnsettledTransactionListResponse *)an.response).anetApiResponse.messages.resultCode isEqualToString:@"Ok"], @"Response Code Get Settled Batch List was not APPROVED");
...
- (void)testStringWithEscapedXMLValue {
    ...
    XCTAssertTrue([escapedString isEqualToString:resultString], @"Error escaping XML value");
}
...
- (void)testStringwithXMLTag {
    ...
    NSLog(@"result = %@", result);
    XCTAssertTrue([escapedXMLTag isEqualToString:result], @"Error generating XML tag.");
